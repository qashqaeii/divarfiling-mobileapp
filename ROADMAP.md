# نقشه راه — Divar Filing Mobile (میزکار اصلی موبایل)
...
# آرشیو — نقشه راه v2 (همراه مشاور)

**نسخه آرشیو:** 2.0  
**تاریخ اصلی:** ۲۵ ژوئن ۲۰۲۶  
**یادداشت:** بخش‌های زیر تاریخی‌اند؛ استراتژی فعلی «میزکار اصلی موبایل» است.
...
| جزء | نقش |
|-----|-----|
| **Django + PostgreSQL** | مرکز — Workspace، CRM، اعلان، منطق کسب‌وکار، استخراج ابری |
| **ویندوز** | اختیاری — استخراج محلی بسیار حجیم و Excel |
| **اندروید** | میزکار روزانه — CRM، Push، فایلینگ، تحلیل، نقشه، استخراج سبک/ابری |

**تمرکز:** UX موبایل حرفه‌ای برای کاربر بدون ویندوز.  
**پرداخت:** فقط وب.
