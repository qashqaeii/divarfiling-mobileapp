...
private fun TemplateCard(
    ...
    DfCard(modifier = modifier.fillMaxWidth()) {
        Column(
            ...
            Text(template.title, style = AppTypography.cardTitle, fontWeight = FontWeight.Bold)
            if (template.category.isNotBlank()) {
                Text(template.category, style = AppTypography.labelSmall, color = DfColors.TextMuted)
            }
            Text(template.body, style = AppTypography.bodyDescription, color = DfColors.TextSecondary)
