...
data class PropertyCreateRequest(
    ...
    @SerialName("publish_status") val publishStatus: String = "پیش‌نویس",
...
data class PropertyUpdateRequest(
    ...
    @SerialName("feature_data") val featureData: Map<String, String>? = null,
)
...
@Serializable
data class ListingFeatureFieldDto(
    val key: String = "",
    val label: String = "",
    val value: String = "",
...
data class AdvertiserAnalysisDto(
    ...
    @SerialName("ai_model_label") val aiModelLabel: String = "",
...
data class ListingDetailDto(
    ...
    @SerialName("has_storage") val hasStorage: Boolean? = null,
    @SerialName("has_elevator") val hasElevator: Boolean? = null,
    @SerialName("has_balcony") val hasBalcony: Boolean? = null,
    @SerialName("has_lobby") val hasLobby: Boolean? = null,
    @SerialName("has_pool") val hasPool: Boolean? = null,
    @SerialName("has_roof_garden") val hasRoofGarden: Boolean? = null,
    @SerialName("has_jacuzzi") val hasJacuzzi: Boolean? = null,
    @SerialName("has_gym") val hasGym: Boolean? = null,
    @SerialName("public_share") val publicShare: ListingPublicShareDto? = null,
    @SerialName("feature_profile") val featureProfile: ListingFeatureProfileDto? = null,
    @SerialName("listing_highlights") val listingHighlights: List<String> = emptyList(),
    @SerialName("feature_fields") val featureFields: List<ListingFeatureFieldDto> = emptyList(),
...
data class ListingUpdateRequest(
    ...
    val balcony: String? = null,
    val lobby: String? = null,
    val pool: String? = null,
    @SerialName("roof_garden") val roofGarden: String? = null,
    val jacuzzi: String? = null,
    val gym: String? = null,
    val images: List<String>? = null,
