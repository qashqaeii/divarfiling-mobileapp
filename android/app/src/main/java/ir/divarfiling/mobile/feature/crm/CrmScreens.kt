    ...
    if (state.showQuickLead) {
        DfModalBottomSheet(onDismissRequest = { viewModel.toggleQuickLead(false) }) {
            ContactQuickLeadSheet(
                ...
                onEmailChange = viewModel::onLeadEmailChange,
                onCityChange = viewModel::onLeadCityChange,
                onDistrictChange = viewModel::onLeadDistrictChange,
                onJobChange = viewModel::onLeadJobChange,
