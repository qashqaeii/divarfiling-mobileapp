...
object AppLinks {
    ...
    const val WORKSPACE_CRM_TEAM_PATH = WorkspaceBridgePaths.CRM_TEAM
    const val WORKSPACE_CONTACT_IMPORT_PATH = WorkspaceBridgePaths.CONTACT_IMPORT
    const val WORKSPACE_CONTACT_IMPORT_TEMPLATE_PATH = WorkspaceBridgePaths.CONTACT_IMPORT_TEMPLATE
    const val WORKSPACE_TEAM = "$SITE_ORIGIN$WORKSPACE_CRM_TEAM_PATH"
    ...
    const val WORKSPACE_AGENCY_WEBHOOKS = "/workspace/crm/agency/settings/webhooks/"
    const val WORKSPACE_AGENCY_AUDIT = "/workspace/crm/agency/settings/audit/"
    const val WORKSPACE_AGENCY_SYNC = "/workspace/crm/agency/settings/sync/"
    const val WORKSPACE_TEAM_SYNC = "/workspace/crm/sync/export/"
    ...
    const val WORKSPACE_CONTACT_IMPORT = "$SITE_ORIGIN$WORKSPACE_CONTACT_IMPORT_PATH"
    const val WORKSPACE_CONTACT_IMPORT_TEMPLATE = "$SITE_ORIGIN$WORKSPACE_CONTACT_IMPORT_TEMPLATE_PATH"
