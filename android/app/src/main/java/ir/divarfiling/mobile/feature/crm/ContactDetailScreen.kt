    ...
    if (state.showEditSheet) {
        DfModalBottomSheet(
            ...
            ContactEditSheet(
                ...
                nationalId = state.editNationalId,
                leaseDeadline = state.editLeaseDeadline,
                ...
                onJobChange = viewModel::onEditJobChange,
                onCompanyNameChange = viewModel::onEditCompanyNameChange,
                onNationalIdChange = viewModel::onEditNationalIdChange,
                onLeaseDeadlineChange = viewModel::onEditLeaseDeadlineChange,
