...
اپ می‌تواند بدون کافه‌بازار، نسخهٔ جدید را از سرور Divar Filing بگیرد و نصب کند.

> **کافه‌بازار:** از flavor `bazaar` (`assembleBazaarRelease`) استفاده کنید. این نسخه آپدیت داخلی ندارد و «بیشتر → بروزرسانی اپ» صفحهٔ کافه‌بازار را باز می‌کند. جزئیات: `docs/CAFEBAZAAR_PLAY_PROTECT.md`

## جریان کاربر (flavor `direct`)
